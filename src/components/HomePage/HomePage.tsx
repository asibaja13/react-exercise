...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    marginBottom: "2%",
    background:
      "no-repeat fixed center url(./assets/img/Extra-Space-Storage.jpg)",
  },
  paper: {
    maxWidth: "50%",
        ...
        <Grid container wrap="nowrap">
          <Grid item lg>
            <Typography
              ...
              variant="h5"
              component="h2"
            >{`Thanks for taking this technical challenge for Extra Space Storage. Please follow these instructions carefully`}</Typography>
          </Grid>
        </Grid>
      </Paper>
      <Paper className={classes.paper}>
        ...
        <Grid container wrap="nowrap">
          <Grid item lg>
            <Typography
              ...
              variant="h6"
              component="h1"
            >{`Complete given tasks (as many as you can)`}</Typography>
          </Grid>
        </Grid>
      </Paper>
      <Paper className={classes.paper}>
          ...
          <Grid item xs>
            <Typography component={"div"}>
              ...
              <ul>
                ...
                <li>{"it should be called from MainMenu Login button."}</li>
              </ul>
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container wrap="nowrap" spacing={2}>
          ...
          <Grid item xs>
            <Typography component={"div"}>
              ...
              <ul>
                <li>{"By default, the user should be logout."}</li>
                <li>{"Add a logout button in the Footer component."}</li>
                <li>
          ...
          <Grid item xs>
            <Typography component={"div"}>
              ...
              <ul>
                ...
                <li>{`You can't select associates with null data.`}</li>
              </ul>
            </Typography>
          </Grid>
        </Grid>
